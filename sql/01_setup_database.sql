...
-- ============================================================================
-- This script creates the foundational database objects for the MFR eMaint
-- demo using Snowflake Intelligence capabilities.
-- ============================================================================

USE ROLE SF_INTELLIGENCE_DEMO;

-- Create the database for MFR reliability platform
CREATE DATABASE IF NOT EXISTS MFR_RELIABILITY_DB
    COMMENT = 'MFR Factory of the Future AI Reliability Platform - Manufacturing Predictive Maintenance';
...
CREATE WAREHOUSE IF NOT EXISTS MFR_ANALYTICS_WH
    WAREHOUSE_SIZE = 'X-SMALL'
    AUTO_SUSPEND = 60
    AUTO_RESUME = TRUE
    COMMENT = 'Warehouse for MFR analytics and AI services';

-- Grant necessary permissions
GRANT USAGE ON DATABASE MFR_RELIABILITY_DB TO ROLE SF_INTELLIGENCE_DEMO;
GRANT USAGE ON ALL SCHEMAS IN DATABASE MFR_RELIABILITY_DB TO ROLE SF_INTELLIGENCE_DEMO;
GRANT ALL ON ALL SCHEMAS IN DATABASE MFR_RELIABILITY_DB TO ROLE SF_INTELLIGENCE_DEMO;
GRANT USAGE ON WAREHOUSE MFR_ANALYTICS_WH TO ROLE SF_INTELLIGENCE_DEMO;

-- Set context for subsequent operations
USE WAREHOUSE MFR_ANALYTICS_WH;

SELECT 'Database setup complete for MFR Reliability Platform' AS STATUS;
